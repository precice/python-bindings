...
class PyPyprecice(PythonPackage):
    ...
    depends_on("precice@2.4.0", when="@2.4.0.0")
    depends_on("precice@2.3.0", when="@2.3.0.1")
    depends_on("precice@2.2.1", when="@2.2.1.1")
    depends_on("precice@2.2.0", when="@2.2.0.1:2.2.0.2")
    depends_on("precice@2.1.1", when="@2.1.1.1:2.1.1.2")
    depends_on("precice@2.1.0", when="@2.1.0.1")
    depends_on("precice@2.0.2", when="@2.0.2.1")
    depends_on("precice@2.0.1", when="@2.0.1.1")
    depends_on("precice@2.0.0", when="@2.0.0.1:2.0.0.2")
